...
1 แยกคำสั่งเดิม Video Prompt ที่สร้างได้
-ปกติจะได้ผลลัพรวมเวลาเราสร้างหรือใส่ข้อความออกมา อยากแยกให้มีกล่องคัดลอกอีกอันที่ไว้สร้างรูปตัวละครอะโดยโครงสร้างยังเหมือนเดิมอะแค่แยกกล่องออกมาเพิ่มอีก 1 แล้วมีปุ่มคัดลอกแยกกัน โดยยังคงคำสั่งเดิมไว้


2 หน้ารอสร้างคำสั่งอยากให้มีระบบโหลดสวยๆผู้ใช้จะได้รู้สึกว่ารออะ นายคิดมาได้เลย
